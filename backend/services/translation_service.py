...
# Devanagari to Ol Chiki phonetic transliterator for unmapped vocabulary / names / loanwords
DEV_TO_OL_CHIKI = {
...
def devanagari_to_olchiki(text: str) -> str:
    """
    Transliterates Hindi Devanagari text into authentic Santali Ol Chiki script.
    Guarantees no Devanagari characters remain in Santali output.
    """
    out = []
    chars = list(text)
    n = len(chars)
    i = 0
    while i < n:
        # Check two-character composites
        if i + 1 < n and (chars[i] + chars[i+1]) in DEV_TO_OL_CHIKI:
            out.append(DEV_TO_OL_CHIKI[chars[i] + chars[i+1]])
            i += 2
        elif chars[i] in DEV_TO_OL_CHIKI:
            out.append(DEV_TO_OL_CHIKI[chars[i]])
            i += 1
        else:
            out.append(chars[i])
            i += 1
...
# Multi-word classroom phrase translations
FLN_SANTALI_PHRASES = {
    "नमस्ते आप सब कैसे हैं": "ᱡᱚᱦᱟᱨ, ᱟᱯᱮ ᱪᱮᱫ ᱞᱮᱠᱟ ᱢᱮᱱᱟᱜ ᱯᱮᱭᱟ",
    "आप सब कैसे हैं": "ᱟᱯᱮ ᱪᱮᱫ ᱞᱮᱠᱟ ᱢᱮᱱᱟᱜ ᱯᱮᱭᱟ",
    "आपका क्या नाम है": "ᱟᱢᱟᱜ ᱧᱩᱛᱩᱢ ᱫᱚ ᱪᱮᱫ",
    "सभी बच्चे यहाँ आओ": "ᱡᱚᱛᱚ ᱜᱤᱫᱽᱨᱟᱹ ᱱᱚᱰᱮ ᱦᱤᱡᱩᱜ ᱯᱮ",
    "सभी बच्चे": "ᱡᱚᱛᱚ ᱜᱤᱫᱽᱨᱟᱹ",
    "सब बच्चे": "ᱡᱚᱛᱚ ᱜᱤᱫᱽᱨᱟᱹ",
    "यहाँ आओ": "ᱱᱚᱰᱮ ᱦᱤᱡᱩᱜ ᱯᱮ",
    "इधर आओ": "ᱱᱚᱛᱮ ᱦᱤᱡᱩᱜ ᱯᱮ",
    "वहाँ जाओ": "ᱦᱟᱸᱰᱮ ᱪᱟᱞᱟᱜ ᱯᱮ",
    "किताब खोलो": "ᱯᱩᱛᱷᱤ ᱡᱷᱤᱡᱽ ᱢᱮ",
    "किताब खोलिए": "ᱯᱩᱛᱷᱤ ᱡᱷᱤᱡᱽ ᱢᱮ",
    "कापी खोलो": "ᱠᱟᱯᱤ ᱡᱷᱤᱡᱽ ᱢᱮ",
    "पानी पियो": "ᱫᱟᱜ ᱧᱩᱭ ᱢᱮ",
    "खाना खाओ": "ᱫᱟᱠᱟ ᱡᱚᱢ ᱢᱮ",
    "बैठ जाओ": "ᱫᱩᱲᱩᱵ ᱯᱮ",
    "खड़े हो जाओ": "ᱛᱤᱸᱜᱩᱱ ᱯᱮ",
    "चुप रहो": "ᱛᱷᱤᱨ ᱛᱟᱦᱮᱸᱱ ᱯᱮ",
    "ध्यान से सुनो": "ᱢᱚᱱ ᱮᱢ ᱠᱟᱛᱮ ᱟᱸᱡᱚᱢ ᱢᱮ",
    "जोर से बोलो": "ᱜᱚᱲ-ᱜᱚᱲ ᱨᱚᱲ ᱢᱮ",
    "साफ लिखो": "ᱥᱟᱯᱷᱟ ᱚᱞ ᱢᱮ",
    "घर जाओ": "ᱚᱲᱟᱜ ᱪᱟᱞᱟᱜ ᱯᱮ",
    "स्कूल आओ": "ᱵᱤᱨᱫᱟᱹᱜᱟᱲ ᱦᱤᱡᱩᱜ ᱯᱮ",
    "कक्षा में": "ᱪᱟᱱᱟᱪ ᱨᱮ",
    "एक साथ": "ᱢᱤᱫ ᱥᱟᱶᱛᱮ",
    "बहुत अच्छा": "ᱟᱹᱰᱤ ᱵᱷᱟᱜᱮ",
    "बहुत सुंदर": "ᱟᱹᱰᱤ ᱪᱚᱨᱚᱠ",
    "धन्यवाद": "ᱥᱟᱨᱦᱟᱣ",
    "अलविदा": "ᱟᱨᱦᱚᱸ ᱵᱚᱱ ᱧᱟᱯᱟᱢᱟ"
}
...
class TranslationService:
    ...
    def translate(
        ...
        if tgt_lang == "sat_Olck" and re.search(r"[\u0900-\u097F]", final_translation):
            final_translation = devanagari_to_olchiki(final_translation)
    ...
    def _linguistic_fln_translate(self, text: str, topic: Optional[str] = None) -> str:
        ...
        # 1. First substitute multi-word phrases
        working_text = trimmed
        for phrase, replacement in sorted(FLN_SANTALI_PHRASES.items(), key=lambda x: len(x[0]), reverse=True):
            if phrase in working_text:
                working_text = working_text.replace(phrase, replacement)

        # 2. Translate remaining tokens
        # Matches words (Devanagari, Ol Chiki, or Latin), punctuation, or whitespace
        tokens = re.findall(r"[\u1C50-\u1C7F]+|[\u0900-\u097F]+|[a-zA-Z0-9]+|[.,!?;:।॥]|\s+", working_text)
        translated_tokens = []
        ...
        for tok in tokens:
            ...
            elif t_strip == "आम" and topic and "fruit" in str(topic).lower():
                translated_tokens.append("ᱩᱞ")
            elif t_strip in FLN_SANTALI_VOCAB:
                translated_tokens.append(FLN_SANTALI_VOCAB[t_strip])
            elif re.search(r"[\u1C50-\u1C7F]", tok):
                # Already Ol Chiki
                translated_tokens.append(tok)
            elif re.search(r"[\u0900-\u097F]", tok):
                # Any unmapped Devanagari word is phonetically transliterated to authentic Ol Chiki
                translated_tokens.append(devanagari_to_olchiki(t_strip))
            else:
                translated_tokens.append(tok)
        ...
        # Ensure any residual Devanagari character is converted to Ol Chiki
        if re.search(r"[\u0900-\u097F]", res):
            res = devanagari_to_olchiki(res)
        return normalize_ol_chiki(res.strip())
